...
test.describe('Page features', () => {
  ...
  test('keyboard shortcuts modal can be closed with Escape after opening via button', async ({
    page,
  }) => {
    await page
      .locator('aside')
...
test.describe('New page creation flow', () => {
  ...
  test('clicking New page in sidebar opens template picker, then Blank page navigates to /new', async ({
    page,
  }) => {
