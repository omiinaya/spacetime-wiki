...
export function TemplateModal({
  open, onClose, templates, selectedTemplate,
  onSelectTemplate, newPageTitle, onNewPageTitleChange,
  onCreateFromTemplate, createDisabled,
}: TemplateModalProps) {
  if (!open) return null;
          ...
          <>
            ...
            {selectedTemplate && (
              <div className="space-y-2 pt-3 border-t border-border">
                <input value={newPageTitle} onChange={(e) => onNewPageTitleChange(e.target.value)}
                ...
                <button onClick={onCreateFromTemplate} disabled={createDisabled}
