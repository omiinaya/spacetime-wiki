...
export function AdminPanels({ userId, allUsers, setAllUsers }: AdminPanelsProps) {
  ...
  return (
    ...
    >
      <div
        className="dialog-container w-full max-w-2xl mx-4 p-5 rounded-xl border border-border bg-card shadow-2xl max-h-[80vh] overflow-y-auto"
