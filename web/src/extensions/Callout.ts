  ...
  renderHTML({ node, HTMLAttributes }) {
    ...
    return [
      ...
      [
        ...
        {
          class:
            'flex items-center gap-2 mb-1 text-xs font-semibold uppercase tracking-wider select-none',
        },
        ['span', { class: 'text-sm leading-none' }, typeDef.icon],
        ['span', { class: `text-${typeDef.color}-400` }, typeDef.label],
      ],
      ['div', { class: 'callout-content prose prose-invert prose-sm max-w-none' }, 0],
    ];
  },
