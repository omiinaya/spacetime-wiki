...
const MockJSZip = vi.hoisted(() => {
  return class {
    ...
    file(name: string, content: unknown) { (this as any).files[name] = content; return this; }
...
const sampleCollections = [
  { id: "col1", name: "Documentation", icon: "📘", slug: "docs", description: "", parent_id: "", color: "", sort_order: 0, created_by: "u1", created_at: 1000, updated_at: 1000 },
  { id: "col2", name: "Guides", icon: "📗", slug: "guides", description: "", parent_id: "", color: "", sort_order: 1, created_by: "u1", created_at: 900, updated_at: 900 },
];
...
describe("BulkExport", () => {
  beforeEach(() => {
    ...
    window.open = vi.fn(() => ({ document: { write: vi.fn(), close: vi.fn() }, focus: vi.fn() } as any));
  });
