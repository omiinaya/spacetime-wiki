...
const sampleNotifications: Notification[] = [
  { id: "n1", user_id: "u1", event_type: "page.create", target_id: "p1", title: "New page created", message: "Alice created a new wiki page", actor_id: "u2", icon: "", is_read: false, created_at: 1000 },
  { id: "n2", user_id: "u1", event_type: "comment.create", target_id: "p2", title: "New comment", message: "Bob commented on your page", actor_id: "u3", icon: "", is_read: true, created_at: 900 },
  { id: "n3", user_id: "u1", event_type: "page.update", target_id: "p3", title: "Page updated", message: "Charlie updated a page", actor_id: "u4", icon: "", is_read: false, created_at: 800 },
];

function renderBell(notifications: Notification[] = sampleNotifications, userId: string | null = "u1", onRefresh?: ReturnType<typeof vi.fn>) {
  const onRefreshFn = onRefresh ?? vi.fn();
  return {
    onRefreshFn,
    ...render(<NotificationBell userId={userId} notifications={notifications} onRefresh={onRefreshFn} />),
  };
}
...
describe("NotificationBell", () => {
  ...
  it("navigates to target page on notification click", () => {
    ...
    renderBell();
    fireEvent.click(screen.getByTitle("Notifications"));
    const notifItem = screen.getByText("New page created").closest('[class*="group"]') || screen.getByText("New page created");
