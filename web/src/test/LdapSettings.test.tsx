...
const sampleProviders = [
  ...
  },
  {
    ...
    port: 636,
    is_secure: true,
    bind_dn: 'svc-bind@adfs.example.com',
    bind_password: '',
    base_dn: 'dc=adfs,dc=example,dc=com',
...
describe('LdapSettings', () => {
  ...
  it('calls api.ldap.add when form submitted', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('ldap.example.com'), {
      target: { value: 'my-ldap.example.com' },
    });
    fireEvent.change(screen.getByPlaceholderText('dc=example,dc=com'), {
      target: { value: 'dc=myorg,dc=com' },
    });
