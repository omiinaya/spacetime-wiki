...
describe("GoogleCallback", () => {
  ...
  it("signs in existing user successfully", async () => {
    ...
    globalThis.fetch = vi.fn().mockImplementation(() => {
      ...
      return Promise.resolve({ json: () => Promise.resolve({ email: "user@gmail.com", name: "Test User" }) });
    });
  ...
  it("registers new user successfully", async () => {
    ...
    globalThis.fetch = vi.fn().mockImplementation(() => {
      ...
      return Promise.resolve({ json: () => Promise.resolve({ email: "newuser@gmail.com", name: "New User" }) });
    });
