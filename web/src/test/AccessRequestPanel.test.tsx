...
const pendingRequests = [
  { id: "req1", page_id: "page1", requester_id: "u1",
    reason: "I need to edit this page", status: "pending",
    responded_by: "", responded_at: 0, created_at: 1700000000000 },
  { id: "req2", page_id: "page2", requester_id: "u2",
    reason: "", status: "pending",
    responded_by: "", responded_at: 0, created_at: 1699900000000 },
];

const approvedRequest = {
  id: "req3", page_id: "page3", requester_id: "u3",
  reason: "Please grant access", status: "approved",
  responded_by: "admin1", responded_at: 1700010000000, created_at: 1699800000000,
};
