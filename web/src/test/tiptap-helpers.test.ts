...
describe("tiptapToMarkdown", () => {
  ...
  it("converts heading with level", () => {
    const doc = { type: "doc", content: [{ type: "heading", attrs: { level: 2 }, content: [{ type: "text", text: "Subtitle" }] }] };
...
describe("htmlToProseMirror", () => {
  ...
  it("converts list, blockquote, code, hr, image, table", () => {
    const html = "<ul><li>A</li></ul><blockquote>Q</blockquote><pre><code>x</code></pre><hr /><figure><img src=\"x.png\" /></figure><table><tr><td>C</td></tr></table>";
