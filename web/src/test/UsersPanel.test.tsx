...
const sampleUsers = [
  { id: "u1", name: "Alice", email: "alice@test.com", role: "admin", avatar_url: "https://example.com/alice.png" },
...
describe("UsersPanel", () => {
  ...
  it("calls api.users.updateAvatar when Save is clicked", async () => {
    ...
    await waitFor(() => {
      expect(mockUpdateAvatar).toHaveBeenCalledWith("u2", "https://example.com/bob-new.png", "admin1");
    });
  });
  ...
  it("renders Google Cloud Console link", () => {
    ...
    expect(link.closest("a")).toHaveAttribute("href", "https://console.cloud.google.com/apis/credentials");
  });
