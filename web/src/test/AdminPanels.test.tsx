...
const sampleGroups = [
  { id: "g1", name: "Editors", description: "Content editors", created_by: "u1", created_at: 1000, updated_at: 1000 },
];

const sampleOidc = [
  { id: "oidc1", name: "Google", slug: "google", issuer_url: "https://accounts.google.com", client_id: "xxx", client_secret: "yyy", scopes: "openid profile email", is_active: true, created_by: "u1", created_at: 1000, updated_at: 1000 },
];

const sampleSaml = [
  { id: "saml1", name: "Okta", slug: "okta", entity_id: "okta.example.com", sso_url: "https://okta.example.com/sso", certificate: "", name_id_format: "emailAddress", attribute_mapping: "{}", auto_register: true, is_active: true, created_by: "u1", created_at: 1000, updated_at: 1000 },
];
...
describe("AdminPanels", () => {
  ...
  it("renders all tab buttons", () => {
    renderAdmin();
    const tabs = ["Dashboard", "Users", "Groups", "Webhooks", "SSO", "Settings", "Features", "Export", "SCIM", "Passkeys", "Invitations", "Access Requests", "MFA", "OAuth", "LDAP"];
