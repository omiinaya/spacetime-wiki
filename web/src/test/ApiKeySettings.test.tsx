...
beforeEach(() => {
  ...
  mockDigest.mockResolvedValue(
    new Uint8Array(Array.from({ length: 32 }, (_, i) => i)).buffer,
  );
});
...
const sampleKeys = [
  { id: "ak1", user_id: "u1", name: "Dev Key", key_hash: "abc", key_prefix: "sw_a1b2c3d4", last_used_at: 2000, created_at: 1000, expires_at: 0, is_revoked: false },
  { id: "ak2", user_id: "u1", name: "CI Key", key_hash: "def", key_prefix: "sw_e5f6g7h8", last_used_at: 1500, created_at: 900, expires_at: 86400000, is_revoked: false },
];
