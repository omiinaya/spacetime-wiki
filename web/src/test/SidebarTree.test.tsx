...
describe('SidebarTree', () => {
  ...
  it('calls setContextMenu on collection right-click', () => {
    ...
    expect(setContextMenu).toHaveBeenCalledWith(expect.objectContaining({ colId: 'c1' }));
  });
  ...
  it('calls setContextMenu on page right-click in uncategorized', () => {
    ...
    expect(setContextMenu).toHaveBeenCalledWith(expect.objectContaining({ pageId: 'p1' }));
  });
