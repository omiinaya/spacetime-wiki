...
const deletedPages = [
  { id: "p1", title: "Old Page", status: "deleted", slug: "old", content: "", text_content: "", collection_id: "", parent_page_id: "", icon: "", color: "", full_width: false, is_pinned: false, is_template: false, template_id: "", sort_order: 0, created_by: "u1", updated_by: "u1", created_at: 1000, updated_at: 1000, published_at: 0, deleted_at: 2000, direction: "ltr" },
  { id: "p2", title: "Trashed Doc", status: "deleted", slug: "trashed", content: "", text_content: "", collection_id: "", parent_page_id: "", icon: "", color: "", full_width: false, is_pinned: false, is_template: false, template_id: "", sort_order: 0, created_by: "u1", updated_by: "u1", created_at: 900, updated_at: 900, published_at: 0, deleted_at: 1900, direction: "ltr" },
];
...
describe("TrashSettings", () => {
  ...
  it("has no accessibility violations with zero retention", async () => {
    ...
    mockListDeleted.mockResolvedValue([]);
    const { container } = renderTrashSettings();
    await waitFor(() => expect(screen.getByText(/Trash is purged immediately/)).toBeInTheDocument());
