...
function ToastTester() {
  ...
  return (
    <div>
      <button onClick={() => addToast({ type: 'info', title: 'Info toast' })}>Add Info</button>
      <button
        onClick={() =>
          addToast({
            type: 'success',
      ...
      <button onClick={() => addToast({ type: 'error', title: 'Error!', duration: 0 })}>
        Add Persistent
      </button>
      <button onClick={() => addToast({ type: 'warning', title: 'Warning!' })}>Add Warning</button>
