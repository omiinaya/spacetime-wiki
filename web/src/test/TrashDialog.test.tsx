...
const mockPages = [
  {
    id: 'p1', title: 'Old Page', slug: 'old', content: '', text_content: '',
    collection_id: 'c1', parent_page_id: '', status: 'deleted', icon: '', color: '',
    full_width: false, is_pinned: false, is_template: false, template_id: '',
    sort_order: 0, created_by: 'u1', updated_by: 'u1', created_at: 1000,
    updated_at: 1000, published_at: 0, deleted_at: 1234567890, direction: '',
  },
  {
    id: 'p2', title: 'Draft Doc', slug: 'draft', content: '', text_content: '',
    collection_id: 'c1', parent_page_id: '', status: 'deleted', icon: '', color: '',
    full_width: false, is_pinned: false, is_template: false, template_id: '',
    sort_order: 1, created_by: 'u1', updated_by: 'u1', created_at: 2000,
    updated_at: 2000, published_at: 0, deleted_at: 1234567890, direction: '',
  },
];
