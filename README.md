...
| [AGENTS.md](AGENTS.md) | Agent-optimized onboarding — task-to-file mappings, workspace layout, conventions, pitfalls |
| [CLAUDE.md](CLAUDE.md) | Short signpost for AI coding assistants — key commands and architecture summary |
| [CONTRIBUTING.md](CONTRIBUTING.md) | Human and AI contributor guide — workflow, conventions, PR process |
| [ROADMAP.md](ROADMAP.md) | Feature parity matrix across Outline, Docmost, Wiki.js, BookStack |
| [IMPROVEMENTS.md](./IMPROVEMENTS.md) | Improvement backlog and good first issues |
| `.env.example` | All configurable environment variables with documentation |
| `docker-compose.yml` | Docker Compose services configuration and ports |
| `server/api-server/openapi.json` | Full OpenAPI spec (auto-generated by FastAPI) |
...
- [SpacetimeDB](https://spacetimedb.com) — the database that makes this possible
- [Outline](https://www.getoutline.com) — design inspiration
- [Hermes Agent](https://hermes-agent.nousresearch.com) — AI agent with native MCP support
