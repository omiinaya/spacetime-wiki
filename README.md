...
| **Database**   | SpacetimeDB v2.6.1 — WebSocket sync, reducers, SQL             |
...
|                | **Tests**                                                      | Vitest (1,365 unit/component) + Playwright (E2E) + vitest-axe (a11y) |
...
- SpacetimeDB CLI (`cargo install spacetimedb-cli --version 2.6.1`)
...
1. Pick an item from [`ROADMAP.md`](ROADMAP.md) (P4-P5 items are good starting points)
2. Branch off `dev` (feature branches off `dev`)
...
459|| [ROADMAP.md](./ROADMAP.md) | Feature parity, improvement backlog, and good first issues |
