...
| Date | Item | Commit |
|------|------|--------|
| 2026-06-30 | **P5 — TypeScript tests for 6 more Tiptap extensions** — Mermaid (6), MathInline (5), MathBlock (6), Transclusion (6), SyncedBlock (6), DatabaseBase (4), ImageEnhanced (7). Total 40 tests covering Node config, parseHTML, renderHTML, attributes, and custom getAttrs. Suite now 1062/1062 clean. | 34381e54 |
