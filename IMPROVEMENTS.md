...
| Priority | Item | Notes |
|----------|------|-------|
| P5 | **Add Rust unit tests for collaboration.rs** | The 6 collaboration reducers don't have unit tests yet (helpers.rs-style tests for validation logic). Add tests for pure functions and session_id format logic. |
