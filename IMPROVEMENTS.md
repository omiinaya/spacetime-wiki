...
|| 2026-06-27 | **P4 — REST API OpenAPI docs!** 30+ Pydantic response models, response_model= annotations on 40+ endpoints, generated OpenAPI 3.0 spec (35 paths, 39 schemas), /openapi-spec.json download endpoint, generate_openapi.py script, sidebar + command palette links to Swagger UI | 5d1e74f |
