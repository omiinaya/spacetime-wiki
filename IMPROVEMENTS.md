...
## Status: Working P3 backlog items — Search result snippets next.
...
| Date | Item | Commit |
|------|------|--------|
| 2026-06-26 | **P3 — Reading time / word count!** Estimated reading time, word count, and character count in PageView footer with live ProseMirror JSON content parsing | (pending commit) |
