...
|| **Frontend Test Files** | **71** (up from 57 — 8 previously uncovered components + 6 Tiptap extension test files now covered) |
|| **Frontend Tests** | **1,370** ✅ (1,316 component tests + 54 Tiptap extension tests) — 0 flaky, 0 skipped, 0 soft assertions ||
| **E2E Spec Files** | 14 |
| **E2E Test Cases** | 79 |
